...
class TabletConnectionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'game_session_room_code', 'connected_at', 'disconnected_at', 'last_seen', 'is_connected'
        ]
        read_only_fields = ['id', 'tablet_code', 'team_name', 'game_session_room_code', 'is_connected']
