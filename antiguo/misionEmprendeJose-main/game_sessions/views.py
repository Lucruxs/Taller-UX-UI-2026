...
class GameSessionViewSet(viewsets.ModelViewSet):
    ...
    def start_stage_1(self, request, pk=None):
        ...
        # Obtener la primera actividad de la Etapa 1 (Personalización, order_number=1 o 2 dependiendo de si existe Video)
        # Buscar Personalización específicamente
        ...
        # Si no encuentra Personalización, tomar la primera actividad por order_number
        ...
        if not first_activity:
            return Response(
                {'error': 'No se encontró la primera actividad de la Etapa 1'},
                status=status.HTTP_404_NOT_FOUND
            )
