...
interface UBotMinijuegoModalProps {
  isOpen: boolean;
  onClose: () => void;
  onIniciar: () => void;
  teamColor?: string;
...
export function UBotMinijuegoModal({ 
  isOpen, 
  onClose, 
  onIniciar,
  teamColor 
}: UBotMinijuegoModalProps) {
  ...
  const fullMessage = `¡Historial previo confirmado! 🤝\nComo ya se conocen, saltaremos las presentaciones básicas. Pasamos directo al Protocolo de Sincronización Avanzada.\n\nTienen 8 minutos para superar 3 desafíos de agilidad mental:\n\n1. Rastreo Visual: Encuentren los objetivos ocultos (Sopa de Letras).\n\n2. Desencriptación: Ordenen los datos corruptos (Anagramas).\n\n3. Inteligencia: Demuestren su nivel de Cultura General.\n\nMisión: Demuestren que la química de este equipo sigue intacta. ¡Velocidad y precisión, agentes!`;
                  ...
                  >
                    <p className="text-white text-sm sm:text-base leading-relaxed whitespace-pre-line">
                      {(() => {
                        ...
                        const boldPhrases = [
                          '¡Historial previo confirmado!',
                          '🤝',
                          'Protocolo de Sincronización Avanzada',
                          '8 minutos',
                          '3 desafíos de agilidad mental',
                          '1. Rastreo Visual',
                          'Sopa de Letras',
                          '2. Desencriptación',
                          'Anagramas',
                          ...
                          'Cultura General',
                          'Misión',
                          'química de este equipo sigue intacta',
                          '¡Velocidad y precisión, agentes!'
                        ];
