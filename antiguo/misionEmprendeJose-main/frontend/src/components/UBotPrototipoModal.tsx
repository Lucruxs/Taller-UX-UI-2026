...
interface UBotPrototipoModalProps {
  isOpen: boolean;
  onClose: () => void;
  onContinuar: () => void;
  teamColor?: string;
...
export function UBotPrototipoModal({ 
  isOpen, 
  onClose, 
  onContinuar,
  teamColor 
}: UBotPrototipoModalProps) {
  ...
  const fullMessage = `¡A construir! 🧱\n\nTienen piezas de LEGO a su disposición. Es el momento de sacar las ideas de su cabeza y llevarlas al mundo real.\n\nMisión: Usen su creatividad para armar un Prototipo (MVP) que represente su gran solución. ¡Denle forma física a su proyecto y suban la foto!`;
