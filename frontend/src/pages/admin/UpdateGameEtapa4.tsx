...
export function UpdateGameEtapa4() {
  const navigate = useNavigate();
  const [loading, setLoading] = useState(false);
  const [selectedStage] = useState<number>(4);
  ...
  useEffect(() => {
    ...
    // Cargar actividades de la Etapa 4 autom�ticamente
    const loadActivities = async () => {
      setLoadingActivities(true);
      try {
        const activitiesData = await challengesAPI.getActivities({ stage: 4, include_inactive: 'true' });
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 text-sm">
                    Lista de actividades de la Etapa 4
                  </p>
                </div>
              </div>
              ...
              {loadingActivities ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {(() => {
                    ...
                    if (false) { // Etapa 4 no necesita esta l�gica
                      ...
                      // Para Etapa 4, mostrar todas las actividades normalmente
                      return activities
