...
interface UBotPersonalizacionModalProps {
  isOpen: boolean;
  onClose: () => void;
  onIniciar: () => void;
  teamColor?: string;
...
export function UBotPersonalizacionModal({ 
  isOpen, 
  onClose, 
  onIniciar,
  teamColor 
}: UBotPersonalizacionModalProps) {
  ...
  const fullMessage = `¡Bienvenidos, Agentes! 🚀\n\nPrimer paso: Registren su Start-up. Definan su nombre y confirmen si ya se conocen como equipo.\n\nMisión: Completen el formulario de abajo para fundar oficialmente su empresa. Este será su nombre durante toda la misión.\n\n¡Comencemos!`;
                    ...
                    <p className="text-white text-sm sm:text-base leading-relaxed whitespace-pre-line">
                      {(() => {
                        ...
                        const boldPhrases = [
                          ...
                          '🚀',
                          'Primer paso',
                          'Registren su Start-up',
                          'Misión',
                          'Completen el formulario',
                          'fundar oficialmente su empresa',
                          'nombre durante toda la misión',
                          '¡Comencemos!'
                        ];
